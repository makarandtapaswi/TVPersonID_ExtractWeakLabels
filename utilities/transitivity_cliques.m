function [cliqs, t_in_cliq] = transitivity_cliques(aff_mat, verbose)
...
if verbose, fprintf('Finding cliques... \n'); end
cliqs = maximalCliques(boolean(aff_mat));
try_again = 5;

while cliques_overlap(cliqs) && try_again
    if verbose, fprintf('Applying transitivity. '); end
